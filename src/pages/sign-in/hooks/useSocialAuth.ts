...
export const useSocialAuth = () => {
  ...
  const initSocialLogin = ({ socialType }: { socialType: SocialType }) => {
    ...
    const socialLoginUrls = {
      ...
      apple: `https://appleid.apple.com/auth/authorize?client_id=${import.meta.env.VITE_APPLE_CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=code&scope=email&state=${socialType}`,
    };
