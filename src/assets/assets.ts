...
export { default as mainCalendar } from "./icon/main-calendar.svg";
export { default as mainRegistration } from "./icon/main-registration.svg";
export { default as mainSearch } from "./icon/main-search.svg";
export { default as mainSign } from "./icon/main-sign.svg";
...
export { default as tag } from "./icon/tag.svg";
export { default as alaram } from "./icon/alarm.svg";
